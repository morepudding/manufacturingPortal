 ...
 * AVEC UN LAYOUT PERSONNALISÉ (BEN_COrderConfirmation-BAT.rdl)
 * 
 * Usage: npx tsx scripts/test-print-order-custom-layout.ts
 */
...
async function testPrintOrder() {
  console.log('🖨️  Test d\'impression Customer Order (Layout Personnalisé)\n')
  ...
  const printRequest: PrintRequest = {
    ...
    languageCode: 'fr',
    copies: 1,
    layoutName: 'BEN_COrderConfirmation-BAT.rdl',  // 🎨 Layout personnalisé
    downloadPdf: false,
  }
  ...
  console.log('  - Layout:', printRequest.layoutName, '(CUSTOM)')
