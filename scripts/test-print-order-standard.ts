 ...
 * AVEC LE REPORT ID STANDARD (pour comparaison)
 * 
 * Usage: npx tsx scripts/test-print-order-standard.ts
 */
...
async function testPrintOrder() {
  console.log('🖨️  Test d\'impression Customer Order (Report Standard)\n')
  
  const printRequest: PrintRequest = {
    orderNo: 'C1000001301',
    reportId: 'CUSTOMER_ORDER_CONF_REP',  // ✅ Report ID standard AST
    printerId: 'PRTBX040',
    languageCode: 'fr',
    copies: 1,
    downloadPdf: false,
  ...
  console.log('  - Report ID:', printRequest.reportId, '(STANDARD)')
